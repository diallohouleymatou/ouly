...
@section('content')
    ...
    <div class="container my-5">
        <div class="row">
            <link href="{{asset('show.css')}}" rel="stylesheet">
            <!-- Image Section -->
            ...
            <!-- Details Section -->
            <div class="col-md-6">
                <h1 class="mb-3">Détails du Burger: {{ $burger->nom }}</h1> <!-- Titre modifié -->
                <p class="lead">Description: {{ $burger->description }}</p> <!-- Titre modifié -->
                <p class="h4 text-primary">
                    <strong>Prix du Burger :</strong> {{ number_format($burger->prix, 2) }} FCFA<!-- Titre modifié -->
                </p>
